function studentName(){
    var studentName="studentName:"+"shivani"
    console.log(studentName);
}
function surName(){
    surName="surName:"+"katipally"
    console.log(surName)
}
surName()
studentName()
...
// 2.logging the first name:inside studentname ,it prints student first name :shivani to the console.After it finishes ,this space is removed from the memeory
...
// 4.logging the surname: inside surname , it prints "students surname : katipally" to the console. After thisthe function finishes, its memory space also removed.
